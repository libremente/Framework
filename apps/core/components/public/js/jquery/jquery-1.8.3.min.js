(function(r,n){function Ab(a){var b=ya[a]={};c.each(a.split(G),function(a,c){b[c]=!0});return b}function za(a,b,d){if(d===n&&1===a.nodeType)if(d="data-"+b.replace(Bb,"-$1").toLowerCase(),d=a.getAttribute(d),"string"===typeof d){try{d="true"===d?!0:"false"===d?!1:"null"===d?null:+d+""===d?+d:Cb.test(d)?c.parseJSON(d):d}catch(e){}c.data(a,b,d)}else d=n;return d}function ma(a){for(var b in a)if(("data"!==b||!c.isEmptyObject(a[b]))&&"toJSON"!==b)return!1;return!0}function N(){return!1}function aa(){return!0}
...
h;g++)d=a[g],d.style&&(f[g]=c._data(d,"olddisplay"),b?(f[g]||"none"!==d.style.display||(d.style.display=""),""===d.style.display&&R(d)&&(f[g]=c._data(d,"olddisplay",La(d.nodeName)))):(e=v(d,"display"),f[g]||"none"===e||c._data(d,"olddisplay",e)));for(g=0;g<h;g++)d=a[g],!d.style||b&&"none"!==d.style.display&&""!==d.style.display||(d.style.display=b?f[g]||"":"none");return a}function Ma(a,b,d){return(a=Fb.exec(b))?Math.max(0,a[1]-(d||0))+(a[2]||"px"):b}function Na(a,b,d,e){b=d===(e?"border":"content")?
...
w.call(arguments).join(","))},map:function(a){return this.pushStack(c.map(this,function(b,d){return a.call(b,d,b)}))},end:function(){return this.prevObject||this.constructor(null)},push:Xa,sort:[].sort,splice:[].splice};c.fn.init.prototype=c.fn;c.extend=c.fn.extend=function(){var a,b,d,e,f,g=arguments[0]||{},h=1,k=arguments.length,l=!1;"boolean"===typeof g&&(l=g,g=arguments[1]||{},h=2);"object"===typeof g||c.isFunction(g)||(g={});k===h&&(g=this,--h);for(;h<k;h++)if(null!=(a=arguments[h]))for(b in a)d=
...
c(q).trigger("ready").off("ready"))}},isFunction:function(a){return"function"===c.type(a)},isArray:Array.isArray||function(a){return"array"===c.type(a)},isWindow:function(a){return null!=a&&a==a.window},isNumeric:function(a){return!isNaN(parseFloat(a))&&isFinite(a)},type:function(a){return null==a?String(a):$a[Mb.call(a)]||"object"},isPlainObject:function(a){if(!a||"object"!==c.type(a)||a.nodeType||c.isWindow(a))return!1;try{if(a.constructor&&!qa.call(a,"constructor")&&!qa.call(a.constructor.prototype,
"isPrototypeOf"))return!1}catch(b){return!1}for(var d in a);return d===n||qa.call(a,d)},isEmptyObject:function(a){for(var b in a)return!1;return!0},error:function(a){throw Error(a);},parseHTML:function(a,b,d){var e;if(!a||"string"!==typeof a)return null;"boolean"===typeof b&&(d=b,b=0);b=b||q;if(e=Za.exec(a))return[b.createElement(e[1])];e=c.buildFragment([a],b,d?null:[]);return c.merge([],(e.cacheable?c.clone(e.fragment):e.fragment).childNodes)},parseJSON:function(a){if(!a||"string"!==typeof a)return null;
...
b.call(a[f],f,a[f++]););return a},trim:ra&&!ra.call("\ufeff\u00a0")?function(a){return null==a?"":ra.call(a)}:function(a){return null==a?"":(a+"").replace(Ob,"")},makeArray:function(a,b){var d,e=b||[];null!=a&&(d=c.type(a),null==a.length||"string"===d||"function"===d||"regexp"===d||c.isWindow(a)?Xa.call(e,a):c.merge(e,a));return e},inArray:function(a,b,d){var c;if(b){if(Ya)return Ya.call(b,a,d);c=b.length;for(d=d?0>d?Math.max(0,c+d):d:0;d<c;d++)if(d in b&&b[d]===a)return d}return-1},merge:function(a,
...
g=this,h=this.length,k=function(){--e||f.resolveWith(g,[g])};"string"!==typeof a&&(b=a,a=n);for(a=a||"fx";h--;)(d=c._data(g[h],a+"queueHooks"))&&d.empty&&(e++,d.empty.add(k));k();return f.promise(b)}});var x,ab,bb,cb=/[\t\r\n]/g,Yb=/\r/g,Zb=/^(?:button|input)$/i,$b=/^(?:button|input|object|select|textarea)$/i,ac=/^a(?:rea|)$/i,db=/^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i,eb=c.support.getSetAttribute;c.fn.extend({attr:function(a,
...
" ").replace(cb," ");f=0;for(g=b.length;f<g;f++)for(;0<=d.indexOf(" "+b[f]+" ");)d=d.replace(" "+b[f]+" "," ");e.className=a?c.trim(d):""}return this},toggleClass:function(a,b){var d=typeof a,e="boolean"===typeof b;return c.isFunction(a)?this.each(function(d){c(this).toggleClass(a.call(this,d,this.className,b),b)}):this.each(function(){if("string"===d)for(var f,g=0,h=c(this),k=b,l=a.split(G);f=l[g++];)k=e?k:!h.hasClass(f),h[k?"addClass":"removeClass"](f);else if("undefined"===d||"boolean"===d)this.className&&
...
changeData:!0},trigger:function(a,b,d,e){if(!d||3!==d.nodeType&&8!==d.nodeType){var f,g,h,k,l,m,s=a.type||a;h=[];if(!gb.test(s+c.event.triggered)&&(0<=s.indexOf("!")&&(s=s.slice(0,-1),f=!0),0<=s.indexOf(".")&&(h=s.split("."),s=h.shift(),h.sort()),d&&!c.event.customEvent[s]||c.event.global[s]))if(a="object"===typeof a?a[c.expando]?a:new c.Event(s,a):new c.Event(s),a.type=s,a.isTrigger=!0,a.exclusive=f,a.namespace=h.join("."),a.namespace_re=a.namespace?RegExp("(^|\\.)"+h.join("\\.(?:.*\\.|)")+"(\\.|$)"):
...
" "])return b?0:h.slice(0);h=a;k=[];for(l=u.preFilter;h;){if(!c||(e=U.exec(h)))e&&(h=h.slice(e[0].length)||h),k.push(f=[]);c=!1;if(e=V.exec(h))f.push(c=new kb(e.shift())),h=h.slice(c.length),c.type=e[0].replace(F," ");for(g in u.filter)!(e=R[g].exec(h))||l[g]&&!(e=l[g](e))||(f.push(c=new kb(e.shift())),h=h.slice(c.length),c.type=g,c.matches=e);if(!c)break}return b?h.length:h?d.error(a):H(a,k).slice(0)}function l(a,b,d){var c=b.dir,e=d&&"parentNode"===b.dir,f=I++;return b.first?function(b,d,f){for(;b=
b[c];)if(e||1===b.nodeType)return a(b,d,f)}:function(b,d,g){if(!g)for(var h,k=ga+" "+f+" ",ib=k+B;b=b[c];){if(e||1===b.nodeType){if((h=b[A])===ib)return b.sizset;if("string"===typeof h&&0===h.indexOf(k)){if(b.sizset)return b}else{b[A]=ib;if(a(b,d,g))return b.sizset=!0,b;b.sizset=!1}}}else for(;b=b[c];)if((e||1===b.nodeType)&&a(b,d,g))return b}}function m(a){return 1<a.length?function(b,d,c){for(var e=a.length;e--;)if(!a[e](b,d,c))return!1;return!0}:a[0]}function s(a,b,d,c,e){for(var f,g=[],h=0,k=
a.length,l=null!=b;h<k;h++)if(f=a[h])if(!d||d(f,c,e))g.push(f),l&&b.push(h);return g}function p(a,b,c,e,f,g){e&&!e[A]&&(e=p(e));f&&!f[A]&&(f=p(f,g));return K(function(g,h,k,l){var m,p,n=[],q=[],jb=h.length,r;if(!(r=g)){r=b||"*";for(var t=k.nodeType?[k]:k,M=[],u=0,T=t.length;u<T;u++)d(r,t[u],M);r=M}r=!a||!g&&b?r:s(r,n,a,k,l);t=c?f||(g?a:jb||e)?[]:h:r;c&&c(r,t,k,l);if(e)for(m=s(t,q),e(m,[],k,l),k=m.length;k--;)if(p=m[k])t[q[k]]=!(r[q[k]]=p);if(g){if(f||a){if(f){m=[];for(k=t.length;k--;)(p=t[k])&&m.push(r[k]=
...
R.POS.test(a)?-1:g.length-1;0<=f;f--){h=g[f];if(u.relative[l=h.type])break;if(l=u.find[l])if(c=l(h.matches[0].replace($,""),S.test(g[0].type)&&b.parentNode||b,e)){g.splice(f,1);a=c.length&&g.join("");if(!a)return y.apply(d,D.call(c,0)),d;break}}}x(a,m)(c,b,e,d,S.test(a));return d}function v(){}var B,z,u,J,w,t,x,G,M,ja,T=!0,A=("sizcache"+Math.random()).replace(".",""),kb=String,O=a.document,L=O.documentElement,ga=0,I=0,ec=[].pop,y=[].push,D=[].slice,C=[].indexOf||function(a){for(var b=0,d=this.length;b<
...
a)},filter:function(a){return this.pushStack(Ba(this,a,!0),"filter",a)},is:function(a){return!!a&&("string"===typeof a?lb.test(a)?0<=c(a,this.context).index(this[0]):0<c.filter(a,this).length:0<this.filter(a).length)},closest:function(a,b){for(var d,e=0,f=this.length,g=[],h=lb.test(a)||"string"!==typeof a?c(a,b||this.context):0;e<f;e++)for(d=this[e];d&&d.ownerDocument&&d!==b&&11!==d.nodeType;){if(h?-1<h.index(d):c.find.matchesSelector(d,a)){g.push(d);break}d=d.parentNode}g=1<g.length?c.unique(g):
...
ta=/^\s+/,mb=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,nb=/<([\w:]+)/,jc=/<tbody/i,kc=/<|&#?\w+;/,lc=/<(?:script|style|link)/i,mc=/<(?:script|object|embed|option|style)/i,ua=RegExp("<(?:"+Da+")[\\s/>]","i"),Ga=/^(?:checkbox|radio)$/,ob=/checked\s*(?:[^=]|=\s*.checked.)/i,nc=/\/(java|ecma)script/i,oc=/^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g,z={option:[1,"<select multiple='multiple'>","</select>"],legend:[1,"<fieldset>","</fieldset>"],thead:[1,"<table>","</table>"],
tr:[2,"<table><tbody>","</tbody></table>"],td:[3,"<table><tbody><tr>","</tr></tbody></table>"],col:[2,"<table><tbody></tbody><colgroup>","</colgroup></table>"],area:[1,"<map>","</map>"],_default:[0,"",""]},pb=Ca(q),va=pb.appendChild(q.createElement("div"));z.optgroup=z.option;z.tbody=z.tfoot=z.colgroup=z.caption=z.thead;z.th=z.td;c.support.htmlSerialize||(z._default=[1,"X<div>","</div>"]);c.fn.extend({text:function(a){return c.access(this,function(a){return a===n?c.text(this):this.empty().append((this[0]&&
...
l=[],m=this.length;if(!c.support.checkClone&&1<m&&"string"===typeof k&&ob.test(k))return this.each(function(){c(this).domManip(a,b,d)});if(c.isFunction(k))return this.each(function(e){var f=c(this);a[0]=k.call(this,e,b?f.html():n);f.domManip(a,b,d)});if(this[0]){e=c.buildFragment(a,this,l);g=e.fragment;f=g.firstChild;1===g.childNodes.length&&(g=f);if(f)for(b=b&&c.nodeName(f,"tr"),e=e.cacheable||m-1;h<m;h++)d.call(b&&c.nodeName(this[h],"table")?Eb(this[h],"tbody"):this[h],h===e?g:c.clone(g,!0,!0));
g=f=null;l.length&&c.each(l,function(a,b){b.src?c.ajax?c.ajax({url:b.src,type:"GET",dataType:"script",async:!1,global:!1,"throws":!0}):c.error("no ajax"):c.globalEval((b.text||b.textContent||b.innerHTML||"").replace(oc,""));b.parentNode&&b.parentNode.removeChild(b)})}return this}});c.buildFragment=function(a,b,d){var e,f,g,h=a[0];b=b||q;b=!b.nodeType&&b[0]||b;b=b.ownerDocument||b;1===a.length&&"string"===typeof h&&512>h.length&&b===q&&"<"===h.charAt(0)&&!(mc.test(h)||!c.support.checkClone&&ob.test(h)||
...
g=0;e[g];++g)Ea(e[g],f[g]);return h},clean:function(a,b,d,e){var f,g,h,k,l,m,n=b===q&&pb,p=[];b&&"undefined"!==typeof b.createDocumentFragment||(b=q);for(f=0;null!=(h=a[f]);f++)if("number"===typeof h&&(h+=""),h){if("string"===typeof h)if(kc.test(h)){n=n||Ca(b);m=b.createElement("div");n.appendChild(m);h=h.replace(mb,"<$1></$2>");g=(nb.exec(h)||["",""])[1].toLowerCase();k=z[g]||z._default;l=k[0];for(m.innerHTML=k[1]+h+k[2];l--;)m=m.lastChild;if(!c.support.tbody)for(l=jc.test(h),k="table"!==g||l?"<table>"!==
...
[];return{browser:a[1]||"",version:a[2]||"0"}};a=c.uaMatch(Wa.userAgent);b={};a.browser&&(b[a.browser]=!0,b.version=a.version);b.chrome?b.webkit=!0:b.webkit&&(b.safari=!0);Wa.userAgent.match(/Trident\/7\./)&&(b.msie=!0,b.version=a.version);c.browser=b;c.sub=function(){function a(b,c){return new a.fn.init(b,c)}c.extend(!0,a,this);a.superclass=this;a.fn=a.prototype=this();a.fn.constructor=a;a.sub=this.sub;a.fn.init=function(f,g){g&&g instanceof c&&!(g instanceof a)&&(g=a(g));return c.fn.init.call(this,
f,g,b)};a.fn.init.prototype=a.fn;var b=a(q);return a}})();var v,F,U,wa=/alpha\([^)]*\)/i,pc=/opacity=([^)]*)/,qc=/^(top|right|bottom|left)$/,rc=/^(none|table(?!-c[ea]).+)/,qb=/^margin/,Fb=RegExp("^("+ha+")(.*)$","i"),ca=RegExp("^("+ha+")(?!px)[a-z%]+$","i"),sc=RegExp("^([-+])=("+ha+")","i"),na={BODY:"block"},tc={position:"absolute",visibility:"hidden",display:"block"},rb={letterSpacing:0,fontWeight:400},C=["Top","Right","Bottom","Left"],Ja=["Webkit","O","Moz","ms"],uc=c.fn.toggle;c.fn.extend({css:function(a,
b){return c.access(this,function(a,b,f){return f!==n?c.style(a,b,f):c.css(a,b)},a,b,1<arguments.length)},show:function(){return Ka(this,!0)},hide:function(){return Ka(this)},toggle:function(a,b){var d="boolean"===typeof a;return c.isFunction(a)&&c.isFunction(b)?uc.apply(this,arguments):this.each(function(){(d?a:R(this))?c(this).show():c(this).hide()})}});c.extend({cssHooks:{opacity:{get:function(a,b){if(b){var d=v(a,"opacity");return""===d?"1":d}}}},cssNumber:{fillOpacity:!0,fontWeight:!0,lineHeight:!0,
...
e))===n)))try{l[b]=d}catch(m){}}else return h&&"get"in h&&(f=h.get(a,!1,e))!==n?f:l[b]}},css:function(a,b,d,e){var f,g;g=c.camelCase(b);b=c.cssProps[g]||(c.cssProps[g]=Ia(a.style,g));(g=c.cssHooks[b]||c.cssHooks[g])&&"get"in g&&(f=g.get(a,!0,e));f===n&&(f=v(a,b));"normal"===f&&b in rb&&(f=rb[b]);return d||e!==n?(a=parseFloat(f),d||c.isNumeric(a)?a||0:f):f},swap:function(a,b,d){var c,f={};for(c in b)f[c]=a.style[c],a.style[c]=b[c];d=d.call(a);for(c in b)a.style[c]=f[c];return d}});r.getComputedStyle?
v=function(a,b){var d,e,f,g,h=r.getComputedStyle(a,null),k=a.style;h&&(d=h.getPropertyValue(b)||h[b],""!==d||c.contains(a.ownerDocument,a)||(d=c.style(a,b)),ca.test(d)&&qb.test(b)&&(e=k.width,f=k.minWidth,g=k.maxWidth,k.minWidth=k.maxWidth=k.width=d,d=h.width,k.width=e,k.minWidth=f,k.maxWidth=g));return d}:q.documentElement.currentStyle&&(v=function(a,b){var d,c,f=a.currentStyle&&a.currentStyle[b],g=a.style;null==f&&g&&g[b]&&(f=g[b]);if(ca.test(f)&&!qc.test(b)){d=g.left;if(c=a.runtimeStyle&&a.runtimeStyle.left)a.runtimeStyle.left=
...
function(a,b){c.cssHooks[a+b]={expand:function(c){var e="string"===typeof c?c.split(" "):[c],f={};for(c=0;4>c;c++)f[a+C[c]+b]=e[c]||e[c-2]||e[0];return f}};qb.test(a)||(c.cssHooks[a+b].set=Ma)});var vc=/%20/g,Gb=/\[\]$/,sb=/\r?\n/g,wc=/^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i,xc=/^(?:select|textarea)/i;c.fn.extend({serialize:function(){return c.param(this.serializeArray())},serializeArray:function(){return this.map(function(){return this.elements?
c.makeArray(this.elements):this}).filter(function(){return this.name&&!this.disabled&&(this.checked||xc.test(this.nodeName)||wc.test(this.type))}).map(function(a,b){var d=c(this).val();return null==d?null:c.isArray(d)?c.map(d,function(a,c){return{name:b.name,value:a.replace(sb,"\r\n")}}):{name:b.name,value:d.replace(sb,"\r\n")}}).get()}});c.param=function(a,b){var d,e=[],f=function(a,b){b=c.isFunction(b)?b():null==b?"":b;e[e.length]=encodeURIComponent(a)+"="+encodeURIComponent(b)};b===n&&(b=c.ajaxSettings&&
c.ajaxSettings.traditional);if(c.isArray(a)||a.jquery&&!c.isPlainObject(a))c.each(a,function(){f(this.name,this.value)});else for(d in a)oa(d,a[d],b,f);return e.join("&").replace(vc,"+")};var P,Q,yc=/#.*$/,zc=/^(.*?):[ \t]*([^\r\n]*)\r?$/mg,Ac=/^(?:GET|HEAD)$/,Bc=/^\/\//,tb=/\?/,Cc=/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,Dc=/([?&])_=[^&]*/,ub=/^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/,vb=c.fn.load,pa={},wb={},xb=["*/"]+["*"];try{Q=Jb.href}catch(Kc){Q=q.createElement("a"),Q.href=
"",Q=Q.href}P=ub.exec(Q.toLowerCase())||[];c.fn.load=function(a,b,d){if("string"!==typeof a&&vb)return vb.apply(this,arguments);if(!this.length)return this;var e,f,g,h=this,k=a.indexOf(" ");0<=k&&(e=a.slice(k,a.length),a=a.slice(0,k));c.isFunction(b)?(d=b,b=n):b&&"object"===typeof b&&(f="POST");c.ajax({url:a,type:f,dataType:"html",data:b,complete:function(a,b){d&&h.each(d,g||[a.responseText,b,a])}}).done(function(a){g=arguments;h.html(e?c("<div>").append(a.replace(Cc,"")).find(e):a)});return this};
...
c.timers.push(a)&&!la&&(la=setInterval(c.fx.tick,c.fx.interval))};c.fx.interval=13;c.fx.stop=function(){clearInterval(la);la=null};c.fx.speeds={slow:600,fast:200,_default:400};c.fx.step={};c.expr&&c.expr.filters&&(c.expr.filters.animated=function(a){return c.grep(c.timers,function(b){return a===b.elem}).length});var zb=/^(?:body|html)$/i;c.fn.offset=function(a){if(arguments.length)return a===n?this:this.each(function(b){c.offset.setOffset(this,a,b)});var b,d,e,f,g,h={top:0,left:0};if(e=(f=this[0])&&
